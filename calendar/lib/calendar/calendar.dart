...
class TempCal extends StatefulWidget {
  TempCal({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<TempCal> {
    ...
    return new Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              //custom icon // This trailing comma makes auto-formatting nicer for build methods.
              ...
              Container(
                ...
                child: new Row(
                  children: <Widget>[
                    Expanded(
                        child: Text( _currentMonth, textAlign: TextAlign.center,
